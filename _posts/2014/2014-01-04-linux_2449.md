---
layout: post
title: Linux 系统中一些针对文件系统的节能技巧
date: '2014-01-04T12:32:00.001+08:00'
author: Wenh Q
tags:
modified_time: '2014-01-04T12:32:08.095+08:00'
blogger_id: tag:blogger.com,1999:blog-4961947611491238191.post-5332012692923793296
blogger_orig_url: http://binaryware.blogspot.com/2014/01/linux_2449.html
---
...
/proc/sys/vm/dirty_writeback_centisecs中。如果在这 5
...
还有一个参数
/proc/sys/vm/dirty_expire_centisecs控制一个更改过的页面经过多长时间后被认为是过期的、必须被写回的页面，其默认值是
3000（单位也是 1/100
...
/proc/sys/vm/dirty_background_ratio参数控制的，此参数的默认值为
