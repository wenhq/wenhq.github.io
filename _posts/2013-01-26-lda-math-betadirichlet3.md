...
author: Wenh Q
tags: - NLP - tech.nlp
modified\_time: '2013-11-30T12:25:43.989+08:00' 
blogger\_id: tag:blogger.com,1999:blog-4961947611491238191.post-2528886975400260080
blogger\_orig\_url: http://binaryware.blogspot.com/2013/01/lda-math-betadirichlet3.html
---
...
](http://www.52nlp.cn/5165/dirichlet-distribution)
$(X\_{(k\_1)},
X\_{(k\_1+k\_2)})
$**的联合分布推导**
...
frac{n!}{(k\_1-1)!(k\_2-1)!(n-k\_1-k\_2)!}x\_1
^{k\_1-1}x\_2
^{k\_2-1}x\_3
^{n-k\_1-k\_2}(
...
Dirichlet 分布
$Dir(x\_1,x\_2,x\_3|k\_1,k\_2,n-k\_1-k\_2+1)
$。令
...
$
2.  令
$p\_1=X\_{(k\_1)}, p\_2=X\_{(k\_1+k\_2)},p\_3 =
    1-p\_1-p\_2
$(加上
$p\_3
$是为了数学表达简洁对称),我们要猜测
...
overrightarrow{m}=(m\_1,m\_2,m\_3),
...
overrightarrow{p}|k\_1+m\_1,k\_1+m\_2,n-k\_1-k\_2+1+m\_3)
$,即
$Dir(
