...
\
你的gtk1程序已经可以使用字体了，但是在gtk1程序里当然还要指定你究竟要使用什么字体。对gtk1程序使用什么字体有一个全局配置文件/etc/gtk/gtkrc.zh\_CN\
把我的配置文件贴一下\
\
\
 \
...
\
 \<!--\
 This expression is added by Akito
Hirai\<[akito@kde.gr.jp](mailto:akito@kde.gr.jp)\> for convenience.\
