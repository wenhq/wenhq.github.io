...
layout: post 
title: "趣文：编程语言伪简史" 
date: '2013-07-02T17:20:00.002+08:00' 
author: Wenh Q
tags:
modified\_time: '2013-07-02T17:20:55.767+08:00' 
blogger\_id: tag:blogger.com,1999:blog-4961947611491238191.post-3168416749159799221
blogger\_orig\_url: http://binaryware.blogspot.com/2013/07/blog-post\_921.html
---
<div
...
书写一套形式语义时，Milner的脑子爆掉了。其他ML家族的著名语言还包括OCaml，F
#，和，Visual
Basic。
...
-   Visual
    Basic近年来吸收了函数式编程里的不少东西（不知道是不是因为受到了F
#影响的缘故）。最典型的是它具备和ML相似的[类型推断](https://en.wikipedia.org/wiki/Type_inference)。
...
Hejlsberg发明了C
#。C
#是一个相对繁冗的、带垃圾收集的、基于类的、静态类型的、单分派的面向对象语言，拥有单实现继承和多接口继承。微软不遗余力地宣传着C
#的独一无二不同凡响之处。
