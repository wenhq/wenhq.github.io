...
author: Wenh Q
tags: - linux
modified\_time: '2013-09-30T15:30:09.079+08:00' 
blogger\_id: tag:blogger.com,1999:blog-4961947611491238191.post-5093446080970946272
...
使用圆括号匹配的示例：（圆括号括起来的正则表达式所匹配的字符串会可以当成变量来使用，sed中使用的是
...
也就是说，原来的文件成了：
    ...
    This is my cat
n  my cat's name is betty
    This is my dog
n  my dog's name is frank
    This is my fish
n  my fish's name is george
    This is my goat
n  my goat's name is adam
