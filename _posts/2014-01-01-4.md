...
| Monac |                                                                  |
| | 1\                                   | o,Lucida Console,monospace; pad |
| ding: |                                                                  |
| | 2\                                   |  5px; white-space: nowrap;">    |
|       |                                                                  |
| | 3\                                   |                                 |
|       |                                                                  |
| | 4\                                   | 毎 k   B\                        |
...
| | 9\                                   | U04:%x\[2,0\]\                  |
|       |                                                                  |
| | 10\                                  | U05:%x\[-2,0\]/%x\[-1,0\]/%x\[0 |
| ,0\]\ |                                                                  |
| | 11\                                  | U06:%x\[-1,0\]/%x\[0,0\]/%x\[1, |
| 0\]\  |                                                                  |
| | 12\                                  | U07:%x\[0,0\]/%x\[1,0\]/%x\[2,0 |
| \]\   |                                                                  |
| | 13\                                  | U08:%x\[-1,0\]/%x\[0,0\]        |
|       |                                                                  |
| | 14                                   |                            \    |
...
| 这一节，而以下部分的说明拿上述日文分词数据举例。在特征模板文件中，每一行(如U00:%x\[-2,0\]）代表一个特征，而宏"%x\[行位置,列 |
| 位                                                                       |
...
| | 11\                                  | ==&gt; 每/日/新\                   |
|    |                                                                     |
| | 12\                                  | U06:%x\[-1,0\]/%x\[0,0\]/%x\[1, |
| 0\]   |                                                                  |
| | 13\                                  |  ==&gt; 日/新/聞\                  |
|    |                                                                     |
| | 14                                   | U07:%x\[0,0\]/%x\[1,0\]/%x\[2,0 |
| \]    |                                                                  |
| |                                      | ==&gt; 新/聞/社\                   |
|    |                                                                     |
| | </div>                               | U08:%x\[-1,0\]/%x\[0,0\]        |
...
| | 16\                                  | \                               |
|       |                                                                  |
| | 17\                                  | def character\_tagging(input\_f |
| ile,  |                                                                  |
| | 18\                                  | output\_file):\                 |
|       |                                                                  |
| | 19\                                  |     input\_data =               |
...
| |                                      |                                 |
|       |                                                                  |
| |                                      | output\_data.write(word\[len(wo |
| rd)-1 |                                                                  |
| |                                      | \]                              |
|       |                                                                  |
| |                                      | + "\\tE\\n")\                   |
...
| | 16\                                  | \                               |
|       |                                                                  |
| | 17\                                  | def character\_split(input\_fil |
| e,    |                                                                  |
| | 18\                                  | output\_file):\                 |
|       |                                                                  |
| | 19\                                  |     input\_data =               |
...
| | 16\                                  | \                               |
|       |                                                                  |
| | 17\                                  | def character\_2\_word(input\_f |
| ile,  |                                                                  |
| | 18\                                  | output\_file):\                 |
|       |                                                                  |
| | 19\                                  |     input\_data =               |
...
| | 33\                                  |             char =              |
|       |                                                                  |
| | 34\                                  | char\_tag\_pair\[0\]\           |
|       |                                                                  |
| | 35\                                  |             tag =               |
|       |                                                                  |
| | 36\                                  | char\_tag\_pair\[2\]\           |
|       |                                                                  |
| | 37\                                  |             if tag == 'B':\     |
|       |                                                                  |
| | 38                                   |                 output\_data.wr |
...
| | 9\                                   | \#\                             |
|       |                                                                  |
| | 10\                                  | \# CRF Segmenter based characte |
| r     |                                                                  |
| | 11\                                  | tagging:\                       |
|       |                                                                  |
| | 12\                                  | \#     4 tags for character tag |
| ging: |                                                                  |
| | 13\                                  | B(Begin), E(End), M(Middle),    |
|       |                                                                  |
| | 14\                                  | S(Single)\                      |
|       |                                                                  |
| | 15\                                  | \                               |
...
| | 20\                                  | \                               |
|       |                                                                  |
| | 21\                                  | def crf\_segmenter(input\_file, |
|       |                                                                  |
| | 22\                                  | output\_file, tagger):\         |
|       |                                                                  |
| | 23\                                  |     input\_data =               |
|       |                                                                  |
| | 24\                                  | codecs.open(input\_file, 'r',   |
|       |                                                                  |
| | 25\                                  | 'utf-8')\                       |
|       |                                                                  |
| | 26\                                  |     output\_data =              |
|       |                                                                  |
| | 27\                                  | codecs.open(output\_file, 'w',  |
|       |                                                                  |
| | 28\                                  | 'utf-8')\                       |
|       |                                                                  |
| | 29\                                  |     for line in                 |
|       |                                                                  |
| | 30\                                  | input\_data.readlines():\       |
|       |                                                                  |
| | 31\                                  |         tagger.clear()\         |
|       |                                                                  |
| | 32\                                  |         for word in line.strip( |
| ):\   |                                                                  |
| | 33\                                  |             word = word.strip() |
| \     |                                                                  |
| | 34\                                  |             if word:\           |
...
| |                                      |         sys.exit()\             |
|       |                                                                  |
| |                                      |     crf\_model = sys.argv\[1\]\ |
|       |                                                                  |
| |                                      |     input\_file = sys.argv\[2\] |
| \     |                                                                  |
| |                                      |     output\_file = sys.argv\[3\ |
| ]\    |                                                                  |
