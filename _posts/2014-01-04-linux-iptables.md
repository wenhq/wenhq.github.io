...
blogger\_id: tag:blogger.com,1999:blog-4961947611491238191.post-1319846314735048291
blogger\_orig\_url: http://binaryware.blogspot.com/2014/01/linux-iptables.html
---
...
　　防火墙的规则指定所检查包的特征，和目标。如果包不匹配，将送往该链中下一条规则检查；如果匹配,那么下一条规则由目标值确定.该目标值可以是用户定义的链名,或是某个专用值,如ACCEPT
[通过
],
DROP
[删除
